...
export default function OomaPortfolio() {
  useEffect(() => {
    ...
    <div id="ooma-page">
      ...
      <nav>
        ...
        <div className="na">
          ...
          <a href="#execution">Execution Lens</a>
        </div>
      </nav>
      ...
      <div className="hero">
        ...
        <p className="hs">A look at where Ooma's AI story stands today, the gap in the market, and where the strongest product opportunities are.</p>
        <div className="hm">
      ...
      <div id="prod"><div className="w">
        ...
        <div>
          ...
          <p>What hasn't been confirmed publicly is how much of this has made it into Ooma Office's SMB product. That's the interesting part. There's clearly active work on the platform side, and the open product question is how those platform capabilities become outcomes that Ooma's 500K+ business users can directly feel.</p>
          <div className="co gr fade">
            <p><strong>Portfolio takeaway:</strong> the opportunity is not invention risk, it's packaging risk. The technical building blocks already exist across Ooma and 2600Hz. The high-leverage PM move is turning those capabilities into a customer-visible AI tier with clear ROI for SMB teams.</p>
          </div>
        </div>
      </div></div>
      ...
      {/* Execution Lens */}
      <div className="fb" id="execution"><div className="w">
        <div className="eb">Execution Lens</div>
        <h2>How I would run this as a PM</h2>

        <div className="pb fade">
          <p style={{ color: "var(--text)", fontSize: "16.5px", lineHeight: "1.75", marginBottom: "20px" }}>This teardown mirrors how I structure product strategy work: quantify the gap, map competitive pressure, identify where value is leaking, and translate that into a sequenced roadmap with measurable business outcomes.</p>
          <p>At <strong>Apsona</strong>, that meant CRM integrations, SMB pricing strategy, and AI workflows that reduced support overhead by 75%. The same thinking applies here: connect feature design to monetization and retention, not just launch velocity.</p>
          <p>At <strong>Capital One</strong>, this approach shaped an AI marketing technology assessment that influenced an $800K investment decision. The operating pattern was similar: narrow an ambiguous market shift into an actionable build-vs-buy call.</p>
        </div>

        <div className="thr" style={{ marginTop: "8px" }}>
          <div className="card fade">
            <h4>Where this strategy starts</h4>
            <p>Prioritize one customer-visible AI capability bundle for Ooma Office, tie it to a packaging test, and instrument adoption + expansion metrics before broad rollout.</p>
          </div>
          <div className="card fade">
            <h4>PM competencies demonstrated</h4>
            <p>Customer discovery, feature prioritization, GTM packaging, build-vs-buy analysis, and translation of technical capability into business-facing product decisions.</p>
          </div>
          <div className="card fade">
            <h4>Execution rhythm</h4>
            <p>Translate research into clear requirements, partner closely with engineering on scope, track leading indicators weekly, and run structured experiments before scaling.</p>
          </div>
        </div>
