...
<h2 class="pd-h2">Three things.<br>One quarter.<br><em>Before Adobe.</em></h2>
<div class="ask-grid">
  <div>
    <ul class="ask-items">
    ...
    <p class="ask-note">I want to help build this as a Summer 2026 intern — product strategy, competitive intelligence, or AXO research. This deck is both the pitch and the evidence. If these ideas are already on the roadmap, I'd like to accelerate them.</p>
  </div>
  <div>
    <div class="ask-cards">
      <div class="ask-card feat"><div class="card-l">What I'm asking for</div><div class="card-v">Summer 2026 internship — product strategy, agent analytics, AXO research</div></div>
      <div class="ask-card"><div class="card-l">Timeline</div><div class="card-v">June through August 2026</div></div>
      <div class="ask-card"><div class="card-l">Deliverables I'd own</div><div class="card-v">AXO Score definition · WebMCP competitive intel · Schema optimization research using the 400M prompt corpus</div></div>
    </div>
    <div class="ask-proof"><strong>What I read to build this:</strong> W3C Community Group Draft, Chrome 146 flag docs, arXiv benchmark (1,890 live API calls), Profound product pages, Adobe Developers Live Nov 2025 notes, Amazon v. Perplexity filing, EU AI Act Article 13, 24 competitor platforms. The 400M prompt moat, attribution loop, and Adobe timeline are original analysis. <strong>I found this gap before anyone told me to look.</strong></div>
  </div>
</div>
`}} />,
...
`}} />,
    ...
    <div className={slideClass(11)} id="psa3" key="sa3" dangerouslySetInnerHTML={{
      __html: `
<div class="eyebrow">Appendix C — About the Author</div>
<h2 class="pd-h2">Why this brief,<br><em>before an offer.</em></h2>
<div class="wm-grid2">
  <div class="wm-cell"><div class="wm-n">01</div><div class="wm-t">Found the gap before it was labeled</div><div class="wm-b">WebMCP was announced Feb 10, 2026. I read the spec independently, mapped it to Profound's architecture, and identified the exact capability rows that were missing. Nobody pointed me here. <strong>Finding inflection points before analysts do</strong> is the most useful thing a PM intern does.</div></div>
  ...
  <div class="wm-cell"><div class="wm-n">03</div><div class="wm-t">Original synthesis, not summaries</div><div class="wm-b">The 400M prompt moat, attribution loop, and Adobe timeline are <strong>not in any analyst report.</strong> They came from connecting Profound's architecture to the technical spec. If any are already on the roadmap — I'd like to know, and help accelerate them.</div></div>
</div>
`}} />,
  ];
